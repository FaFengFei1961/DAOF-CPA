...
var SubscriptionSysConfigDefaults = map[string]string{
	...
	"billing_model_weights_json":         `[{"pattern":"claude-haiku-*","weight":1,"label":"Claude Haiku","reason":"当前启用的 Claude 轻量系列"},{"pattern":"claude-sonnet-*","weight":1,"thinking_weight":1.25,"label":"Claude Sonnet","reason":"当前启用的 Claude 基准系列；thinking 启用时加权"},{"pattern":"claude-opus-*","weight":1,"thinking_weight":1.5,"label":"Claude Opus","reason":"当前启用的 Claude 高消耗系列"},{"pattern":"gemini-*-flash-lite*","weight":1,"label":"Gemini Flash Lite","reason":"当前启用的 Gemini 超轻量系列"},{"pattern":"gemini-*-flash*","weight":1,"label":"Gemini Flash","reason":"当前启用的 Gemini 快速系列"},{"pattern":"gemini-*-pro*","weight":1,"label":"Gemini Pro","reason":"当前启用的 Gemini 主力系列"},{"pattern":"gpt-*-mini*","weight":0.9,"label":"GPT mini","reason":"当前启用的 GPT 轻量系列"},{"pattern":"gpt-*","weight":1,"label":"GPT","reason":"当前启用的 GPT 主力系列"},{"pattern":"grok-*","weight":0.8,"label":"Grok","reason":"当前启用的 xAI Grok 系列"}]`,
	...
	// ── 拉新消费返佣 ──
	ReferralPaidSpendRewardBPSConfigKey:           "0",       // 0=关闭；100=1%
	ReferralPaidSpendRewardWindowSecondsConfigKey: "2592000", // 默认 30 天有效期
}
