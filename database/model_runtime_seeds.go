...
func defaultModelSeeds() []defaultModelSeed {
	...
	return []defaultModelSeed{
		...
		{ProviderKey: "google", ProviderName: "Google Gemini", ModelID: "gemini-3.1-flash-image", DisplayName: "Gemini 3.1 Flash Image", OfficialStatus: "alias_or_unofficial", Category: ModelCategoryImage, BillingMode: BillingModeToken, Supported: false, Public: false, DefaultEnabled: false, SourceURL: googlePricing, Token: defaultTokenPrice{Input: "0.50", Output: "60"}, Notes: "Gemini 3 flash image（无 -preview 后缀的 alias）；token-billed via usageMetadata.candidatesTokenCount × $60/Mtok。接通路径 /v1beta/models/gemini-3.1-flash-image:generateContent。admin 启用：AllowedEndpoints 加 /v1beta/models 后切 Supported=true。"},
		{ProviderKey: "google", ProviderName: "Google Gemini", ModelID: "gemini-3.1-flash-image-preview", DisplayName: "Gemini 3.1 Flash Image Preview", OfficialStatus: "alias_or_unofficial", Category: ModelCategoryImage, BillingMode: BillingModeToken, Supported: false, Public: false, DefaultEnabled: false, SourceURL: googlePricing, Token: defaultTokenPrice{Input: "0.50", Output: "60"}, Notes: "Gemini 3.1 Flash Image Preview；token-billed via usageMetadata.candidatesTokenCount × $60/Mtok（公开 image-modality output rate）。接通路径 /v1beta/models/gemini-3.1-flash-image-preview:generateContent。admin 启用：AllowedEndpoints 加 /v1beta/models 后切 Supported=true。"},
		{ProviderKey: "google", ProviderName: "Google Gemini", ModelID: "gemini-2.5-flash-image", DisplayName: "Gemini 2.5 Flash Image", OfficialStatus: "alias_or_unofficial", Category: ModelCategoryImage, BillingMode: BillingModeToken, Supported: false, Public: false, DefaultEnabled: false, SourceURL: googlePricing, Token: defaultTokenPrice{Input: "0.30", Output: "30"}, Notes: "Gemini 2.5 GA image generation；token-billed via usageMetadata.candidatesTokenCount × $30/Mtok。接通路径 /v1beta/models/gemini-2.5-flash-image:generateContent。admin 启用：AllowedEndpoints 加 /v1beta/models 后切 Supported=true。"},
		{ProviderKey: "google", ProviderName: "Google Gemini", ModelID: "gemini-3-pro-image-preview", DisplayName: "Gemini 3 Pro Image Preview", OfficialStatus: "alias_or_unofficial", Category: ModelCategoryImage, BillingMode: BillingModeToken, Supported: false, Public: false, DefaultEnabled: false, SourceURL: googlePricing, Token: defaultTokenPrice{Input: "2.00", Output: "120"}, Notes: "Gemini 3 Pro image preview（allowlist 受限）；token-billed via usageMetadata.candidatesTokenCount × $120/Mtok。接通路径 /v1beta/models/gemini-3-pro-image-preview:generateContent。admin 启用：AllowedEndpoints 加 /v1beta/models 后切 Supported=true。"},
