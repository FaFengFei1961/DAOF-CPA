...
func defaultModelSeeds() []defaultModelSeed {
	...
	return []defaultModelSeed{
		...
		// gemini-3.5-flash: 2026-05-19 GA at Google I/O 2026。CPA 2026-05-20 上游 sync 加入。
		// 官方 pricing (ai.google.dev/gemini-api/docs/pricing) 抓取于 2026-05-20：
		//   Input $1.50 / Output $9.00（含 thinking tokens）/ Cached $0.15 per 1M
		//   无 HighAt 阶梯；non-global region 加价至 $1.65/$9.90（DAOF 仅按 global 计费）
		// 定位：「frontier-quality flash for agentic / coding / long-horizon tasks」——
		// 比 gemini-3-flash-preview ($0.5/$3) 贵 3 倍，但比 gemini-3.1-pro-preview ($2/$12)
		// 便宜约 40%。
		{ProviderKey: "google", ProviderName: "Google Gemini", ModelID: "gemini-3.5-flash", DisplayName: "Gemini 3.5 Flash", OfficialStatus: "official_exact", Category: ModelCategoryText, BillingMode: BillingModeToken, Supported: true, Public: true, DefaultEnabled: true, SourceURL: googlePricing, Token: defaultTokenPrice{Input: "1.5", Output: "9", Cached: "0.15"}},
